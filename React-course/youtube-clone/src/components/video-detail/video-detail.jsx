import { Avatar, Box, Chip, Stack, Typography, Paper, Divider } from '@mui/material';
import { useState, useEffect } from 'react';
import { Link, useParams } from 'react-router-dom';
import ReactPlayer from 'react-player';
import { CheckCircle, ThumbUpOutlined, ShareOutlined, MoreHoriz, Tag } from '@mui/icons-material';
				...
				<Box sx={{ flex: 1, minWidth: 0 }}>
					...
					<Box sx={{ px: { xs: 2, sm: 0 }, mt: 2 }}>
						...
						>
								...
								<Stack direction='row' alignItems='center' spacing={2} sx={{ mb: 2 }}>
									...
									<Box sx={{ flex: 1 }}>
										<Stack direction='row' alignItems='center' spacing={0.5}>
											...
											<CheckCircle sx={{ fontSize: '14px', color: '#606060' }} />
										</Stack>
									</Box>
								</Stack>
							</Link>
							...
							{/* Comments Count */}
							<Divider sx={{ my: 2 }} />
							<Typography variant='body2' sx={{ color: '#0f0f0f', fontWeight: 600 }}>
